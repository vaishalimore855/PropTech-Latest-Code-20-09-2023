...
import { getInvestorSubscriptionList } from "../../../Redux/Slice/InvestorSubSlice";
...
const InvestorSubscription = () => {
  ...
  useEffect(() => {
    dispatch(getInvestorSubscriptionList(type));
  }, [dispatch]);

  // Access the PropertyList from the Redux store
  const SubscriptionList = useSelector(
    (state) => state.InvestorSubscriptionData.InvestorSubscriptions
  );
