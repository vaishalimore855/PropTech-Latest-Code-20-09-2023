...
const BuyerSubscription = () => {
  ...
  useEffect(() => {
    dispatch(getSubscriptionList(type));
  }, [dispatch, type]);
              ...
              <div className="page-header mt-5">
                ...
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item">
                      <Link to="#"style={{ fontSize: "16px" }}>Buyer Subscription Management</Link>
                    </li>
                      ...
                      <div className="pt-4 pb-4 text-left">
                        <div className="row">
                          <div className="d-flex justify-content-between">
                            ...
                            >
                              <Link to="/add-buyersub" className="text-white">
                                + Add Subscription
                              </Link>
                            </button>
                            ...
                            <tbody style={{ textAlign: "center" }}>
                              {SubscriptionList.map((subscribe, index) => (
                                <tr key={index}>
                                  ...
                                  <td>{subscribe?.status ? "True" : "False"}</td>
