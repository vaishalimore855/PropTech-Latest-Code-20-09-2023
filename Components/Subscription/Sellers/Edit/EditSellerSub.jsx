...
// import { getSellerSubscriptionbyId } from "../../../../Redux/Slice/SellerSubSlice";
...
//   };
//   useEffect(() => {
//     dispatch(getSellerSubscriptionbyId(id));
//   }, [id]);
...
//                 <li className="breadcrumb-item">
//                   <Link to="/subscription"style={{ fontSize: "16px" }}>Subscriptions</Link>
//                 </li>
...
const EditSellerSub = () => {
  ...
  const dispatch = useDispatch();
  const Subscription = useSelector(
    (state) => state.SellerSubscriptionData.SellerSubscription
  );
