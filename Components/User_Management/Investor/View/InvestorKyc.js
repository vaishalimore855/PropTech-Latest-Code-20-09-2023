...
function InvestorKyc() {
  ...
  useEffect(() => {
    dispatch(getKycInvestorUserid(userId, token));
  }, [userId, token]);
          ...
          <dl className="row ">
            ...
            <dd className="col-4">
              {InvestorKyc?.aadhar_front_base64 ? (
                ...
                >
                  <img
                    src={`data:image/png;base64, ${InvestorKyc?.aadhar_front_base64}`}
                    alt=""
                    width="100%"
                    height="100%"
                  />
            ...
            <dd className="col-4">
              {InvestorKyc?.aadhar_back_base64 ? (
                ...
                >
                  <img
                    src={`data:image/jpeg;base64, ${InvestorKyc?.aadhar_back_base64}`}
                    alt=""
                    width="100%"
                    height="100%"
                  />
          ...
          <dl className="row">
            ...
            <dd className="col-4">
              {InvestorKyc?.pan_base64 ? (
                ...
                >
                  <img
                    src={`data:image/jpeg;base64, ${InvestorKyc?.pan_base64}`}
                    alt=""
                    width="100%"
                    height="100%"
                  />
